        ...
        <div class="row gy-5">
          <div class="col-xl-12" data-aos="fade-left" data-aos-delay="300">
            <div class="service-block">
              ...
              <img src="<?=BASE_URL?>assets/img/real-estate/property-exterior-7.webp" alt="Sell Property" class="img-fluid">
            ...
            <div class="service-block">
              <div class="service-content">
                ...
                <div class="service-info">
                  ...
                  <form action="arrendamento.php" method="GET">
              ...
              <div class="service-image">
                <img src="<?=BASE_URL?>assets/img/real-estate/property-interior-5.webp" alt="Premium Rentals" class="img-fluid">
                <div class="image-overlay">
                  <i class="bi bi-key"></i>
                </div>
              </div>
