        ...
        <div class='modal-dialog modal-dialog-centered' role='document'>
            <div class='modal-content'>
                ...
                <div class='modal-footer'>
                    ...
                    <form action='../../processo/imovel/A_galeria_imagem_excluir_consul.php' method='post' class='d-inline'>
                        <input type='hidden' name='id' value='<?= $id_galeria ?>'>
