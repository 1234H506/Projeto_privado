...
$sql = "SELECT i.Morada , i.Imagens , i.Comentariosderaridade , i.ID_Imoveis , i.Preco , i.Tipodeimovel , a.nome , a.Servicos
...
function exibirCardArquivadas($titulo, $imagem, $preco, $descricao, $agente, $imovel, $id,$servicos)
{ ?>
        ...
        <div class='card shadow mb-4'>
            ...
            <div class='card-body'>
                ...
                <div class='card-body'>
                    ...
                    <p><?= preco_formatado($preco,$servicos) ?></p>
                            ...
                            <div class='modal-dialog modal-dialog-centered' role='document'>
                                <div class='modal-content'>
                                    ...
                                    <div class='modal-footer'>
                                        ...
                                        <form action='../../processo/imovel/A_excluirCasasarquivadas.php' method='post' class='d-inline'>
                            ...
                            <div class='modal-dialog modal-dialog-centered' role='document'>
                                <div class='modal-content'>
                                    ...
                                    <div class='modal-footer'>
                                        ...
                                        <form action='../../processo/imovel/A_desarquivar_Casa.php' method='post' class='d-inline'>
                                            <input type='hidden' name='id' value='<?= $id; ?>'>
