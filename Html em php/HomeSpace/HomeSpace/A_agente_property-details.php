                ...
                <div class="property-gallery-slider swiper init-swiper">
                  ...
                  <div class="swiper-wrapper">
                    ...
                    <?php foreach ($imovel->imagens as $foto): ?>
                      <div class="swiper-slide">
                        <img src="/administracao1/startbootstrap-sb-admin-2-gh-pages/img/galeria/<?= $foto ?>"
            ...
            <div class="sticky-sidebar">
              ...
              <div class="agent-card mb-4" data-aos="fade-up" data-aos-delay="350">
                <div class="agent-header">
                  <div class="agent-avatar">
                    <img src="/administracao1/startbootstrap-sb-admin-2-gh-pages/img/agents/<?= $agente_imagem; ?>"
                ...
                <div class="agent-contact">
                  <div class="contact-item">
                    ...
                    <span><?php echo num_Formatado($agente_telemovel); ?></span>
                  </div>
                  <div class="contact-item">
                ...
                <div class="agent-actions mt-3">
                  <form action="A_service-details.php" method="POST">
              ...
              if (mysqli_num_rows($result_similar) > 0) {
                while ($row = mysqli_fetch_assoc($result_similar)) {
                  ...
                  <div class="similar-property-item" onclick="window.location.href='A_agente_property-details.php?id=<?= $ps_idimovel; ?>'">
                  <img src="/administracao1/startbootstrap-sb-admin-2-gh-pages/img/principal/<?= $ps_imagem ?>" class="img-fluid" alt="Similar Property">
