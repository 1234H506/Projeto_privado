          ...
          <div class="container" data-aos="fade-up" data-aos-delay="100">
            <div class="row gy-4" id="cards">
              <?php while ($row = $resultado_agentes2->fetch_assoc()) { ?>
                <div class="col-lg-3 col-md-6 agent-item" data-aos="zoom-in" data-aos-delay="100">
                  <div class="featured-agent">
                    <div class="agent-wrapper">
                      <div class="agent-photo">
                        <img src="../../administracao/img/agents/<?= $row['Imagem'] ?>" alt="Foto agentes"
                          class="img-fluid">
                      </div>
                      <div class="agent-details">
                        ...
                        <a href="../agentes/agent-profile.php?id=<?= $row["ID_Agentes"] ?>" class="view-profile">Ver
                          listagens</a>
                      </div>
                    </div>
                  </div>
