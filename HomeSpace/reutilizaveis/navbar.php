...
<nav id="navmenu" class="navmenu">
  <ul>
    ...
    <li><a href="<?=BASE_URL?>pagina/properties.php">Propriedades</a></li>
    <li><a href="<?=BASE_URL?>pagina/services.php">Serviços</a></li>
    <li><a href="<?=BASE_URL?>pagina/A_agents.php">Agentes</a></li>
    <li><a href="<?=BASE_URL?>pagina/contact.php">Contacto</a></li>
...
?>
            ...
            <span class="small text-muted"><?= htmlspecialchars($_SESSION['email'] ?? ''); ?></span>
          </div>
...
?>
            ...
            <p class="text-muted small"><?= htmlspecialchars($_SESSION['email'] ?? ''); ?></p>
          </div>

          <div class="dropdown-divider my-3"></div>

          <!-- Links de ações (mesmo visual clean do login) -->
          <a href="../autenticacao/user_profile.php" class="d-flex align-items-center py-3 px-3 text-decoration-none text-dark" style="border-radius: 10px;">
            <i class="bi bi-person me-3 text-success fs-5"></i>
            <span class="fw-medium">Meu Dados</span>
          </a>
          <a href="../autenticacao/minhas_acao.php" class="d-flex align-items-center py-3 px-3 text-decoration-none text-dark" style="border-radius: 10px;">
    ...
    <?php } else {  ?>
      ...
      <li class="dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-end shadow border-0 p-4" style="min-width: 360px; border-radius: 15px;">
          ...
          <form action="../autenticacao/consul_login.php" method="POST">
            <div class="mb-3">
