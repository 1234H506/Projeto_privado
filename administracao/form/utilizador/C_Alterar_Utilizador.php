            ...
            <div id="content">
                ...
                <div class="d-flex justify-content-center mt-4">
                    <div class="col-md-8 col-lg-6">
                        ...
                        <form class="row g-3" action="../../processo/utilizador/C_alterar_utilizador_consul.php" method="POST"
                            ...
                            <div class="col-12 mt-3">
                                ...
                                <input type="text" class="form-control" id="inputNome" name="nome"
                                    value="<?= $nome ?>" autocomplete="off" required>
                            </div>
                            ...
                            <div class="col-6 mt-3">
                                ...
                                <input type="text" class="form-control" id="inputNumero" name="numero"
                                    value="<?= num_Formatado($tel) ?>" autocomplete="off" maxlength="9" required>
                            </div>
                            ...
                            <div class="col-6 mt-3">
                                ...
                                <select class="form-control" id="inputAdmin" name="Admin" required>
                                    <option value="0" <?= ($admin == "Utilizador") ? 'selected' : ''; ?>>Utilizador
                                    </option>
                                    <option value="1" <?= ($admin == "Admin") ? 'selected' : ''; ?>>Admin</option>
                                </select>
                            </div>
