            ...
            <div id="content">
                ...
                <div class="d-flex justify-content-center mt-4">
                    <div class="col-md-8 col-lg-6">
                        ...
                        <form class="row g-3" id="alterarAgente" action="B_alterar_agentes_consul.php" method="POST"
                            ...
                            <div class="col-6 mt-3">
                                ...
                                <input type="text" class="form-control" id="inputNumero" name="numero"
                                    value="<?php echo $tel ?>" maxlength="9"  required>
                            </div>
                            ...
                            <div class="col-6 mt-3">
                                ...
                                <select class="form-control" id="inputServicos" name="servicos"
                                    value="<?php echo $servicos ?>" required>
                                    <?php
                                    $lista = ["Arrendamento", "Vendas", "Compras"];
                                    foreach ($lista as $value) {
                                        ?>
                                        <option value="<?php echo $value; ?>" <?php if (strcasecmp($value, $servicos) === 0)
                                               echo 'selected'; ?>>
                                            <?php echo $value; ?>
                                        </option>
                                    <?php } ?>
