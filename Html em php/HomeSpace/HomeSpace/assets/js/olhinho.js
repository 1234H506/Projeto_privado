...
if (btnProcurar) {
    btnProcurar.addEventListener("click", function () {
        ...
        const localizacao = document.getElementById('localizacao_do_imovel').value;
        const tipo = document.getElementById('tipo_de_imovel').value;
        const preco = document.getElementById('media_de_preco').value;
        const idAgente = document.getElementById('id_agente').value;
