        ...
        <div class='card shadow mb-4'>
            ...
            <div class='card-body'>
                ...
                <div class='d-flex flex-wrap justify-content-between mt-5 w-100' style="gap: 5px;">
                    ...
                    <form action='../../form/imovel/A_alterar_registro.php' method='post' class='d-inline'>
                    ...
                    <div class='modal-dialog modal-dialog-centered' role='document'>
                        <div class='modal-content'>
                            ...
                            <div class='modal-footer'>
                                ...
                                <form action='../../processo/imovel/A_arquivar_imovel_consul.php' method='post' class='d-inline'>
                                    <input type='hidden' name='id' value='<?= $id ?>'>
                ...
                <div class='modal fade' id='modalExcluirimovel<?= $id ?>' tabindex='-1' role='dialog'>
                    <div class='modal-dialog modal-dialog-centered' role='document'>
                        <div class='modal-content'>
                            ...
                            <div class='modal-footer'>
                                <button type='button' class='btn btn-secondary' data-dismiss='modal'>Não</button>
                                <form action='../../processo/imovel/A_excluir_imovel_consul.php' method='post' class='d-inline'>
                                    <input type='hidden' name='id' value='<?= $id ?>'>
