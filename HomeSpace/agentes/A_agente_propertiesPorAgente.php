...
// Verificação se o id chega por post
$id = $_POST['Id_Do_Agente'];

$sql_informacao_do_agente = "SELECT a.nome, COUNT(i.ID_Imoveis) as 'Contagem_de_imovel', a.Servicos FROM agentes a LEFT JOIN imoveis i ON a.ID_Agentes = i.Agentes_ID_Agentes WHERE a.ID_Agentes = $id GROUP BY a.nome";
$resultado_do_agente = mysqli_query($conn, $sql_informacao_do_agente);
if (mysqli_num_rows($resultado_do_agente) > 0) {
  while ($row = mysqli_fetch_assoc($resultado_do_agente)) {
    $Nome_do_agente = $row["nome"];
    $Contagem_do_imovel_por_agente = $row["Contagem_de_imovel"];
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="row g-3">
                  <div class="col-lg-4 col-md-6">
                    <div class="search-field">
                      ...
                      <input type="text" class="form-control" placeholder="Digite a morada" id="localizacao_do_imovel">
                    </div>
                  </div>
                  <div class="col-lg-4 col-md-6">
                    <div class="search-field">
                      <label>Tipo</label>
                      <select class="form-select" id="tipo_de_imovel">
                  ...
                  <div class="col-lg-3 col-md-6">
                    <div class="search-field">
                      <label>Preços</label>
                      <select class="form-select" id="media_de_preco">
                  ...
                  <div>
                    <input type="hidden" value="<?= $id; ?>" id="id_agente">
                  </div>
                  <div class="col-lg-4 col-md-12">
                    <div class="search-field">
                      <label>&nbsp;</label>
                      <button class="btn btn-primary w-100 search-btn" id="btn_procurar">
          ...
          <div class="row align-items-center">
            <div class="col-lg-6">
              <div class="results-info">
                <h5>Propriedades encontradas : <?= $Contagem_do_imovel_por_agente; ?> </h5>
                <p class="text-muted">Exibinção imóveis do responsável : <?= $Nome_do_agente; ?></p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="properties-container">
          ...
          <div class="properties-masonry view-masonry active" data-aos="fade-up" data-aos-delay="250">
            <div class="row g-4" id="lista_imoveis"> <!--    para o AJAX-->

              <?php
              // Condição se tivermos o id faz uma busca de imovel com id do agente 
              if (isset($id)) {
                $sql = " SELECT COUNT(g.Fotos) as Fotos , a.Servicos , a.nome , a.NdeTelemovel ,  i.Freguesia , i.Morada, i.concelho , i.Distrito , i.Codigopostal , i.Areautil , i.Tipologia , i.ID_Imoveis , i.Tipodeimovel , i.Areautil , i.Preco , i.Imagens , i.Estado FROM agentes a, galeria g, imoveis i WHERE i.Agentes_ID_Agentes = a.ID_Agentes AND i.ID_Imoveis = g.Imoveis_ID_Imoveis AND a.ID_Agentes = $id AND i.Disponibilidade = 1 GROUP BY i.ID_Imoveis;";
          ...
          <div class="row justify-content-between align-items-center">
            <div class="col-lg-6">
              <div class="pagination-info">
                <p>Exibindo <strong>1-<?= $Contagem_do_imovel_por_agente; ?></strong> de <strong>124</strong> propriedades</p>
              </div>
            </div>
            <div class="col-lg-6">
