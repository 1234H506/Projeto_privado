...
$acao = $_POST['id_servico'] ?? $_GET['id_servico'] ?? '';
              ...
              <div class="row justify-content-between align-items-center">
                ...
                <div class="col-lg-6">
                  <ul class="pagination justify-content-lg-end">
                    <?php if ($pagina > 1): ?>
                      <li class="page-item">
                        <a class="page-link" href="?id_servico=<?= urlencode($acao) ?>&page=<?= $pagina - 1 ?>">
                    ...
                    <?php for ($i = 1; $i <= $total_paginas; $i++): ?>
                      <li class="page-item <?= ($pagina == $i) ? 'active' : '' ?>">
                        <a class="page-link" href="?id_servico=<?= urlencode($acao) ?>&page=<?= $i ?>">
                          <?= $i ?>
                        </a>
                      </li>
                    <?php endfor; ?>
