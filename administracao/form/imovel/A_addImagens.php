                ...
                <div class="container-fluid mb-5">
                    ...
                    <nav aria-label="breadcrumb" class="mt-4">
                        <ol class="breadcrumb bg-white shadow-sm border-left-primary">
                            <li class="mr-5">
                                <a href="../../templates/imoveis/A_galeria_imagem.php" class="btn btn-primary btn-circle ">
                        ...
                        <div class="col-xl-8 col-lg-10">
                            ...
                            <div class="card shadow border-bottom-primary">
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="../../processo/imovel/A_addImagens_consul.php" method="POST" enctype="multipart/form-data" id="galeria_imagens">

                                        <input type="hidden" name="id_imovel"
                                            value="<?= $_SESSION['id_imovel'] ?? ''; ?>">
                                        ...
                                        <div class="mt-4 text-center">
                                            <button type="button" name="submit" id="btnConfirmacao" data-toggle="modal"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-success" form="galeria_imagens">
                        Sim
                    </button>
                </div>
