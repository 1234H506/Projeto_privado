...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- /templates/C_tablesUtilizador.php -->
            ...
            <div id="content">
                ...
                <div class="d-flex justify-content-center mt-4">
                    <div class="col-md-8 col-lg-6">
                        ...
                        <form class="row g-3" action="../../processo/agendamento/D_Alterar_registro_consul.php" method="post">
                            ...
                            <div class="col-6 mt-3">
                                ...
                                <input type="date" class="form-control" id="inputData" name="dataDeRegistro"
                                    value="<?= htmlspecialchars($data_apenas) ?>" required>
                            </div>
                            ...
                            <div class="col-6 mt-3">
                                ...
                                <input type="text" class="form-control" id="input_status" name="input_status"
                                    value="<?= htmlspecialchars($Curso_da_visita) ?>" readonly>
                            ...
                            <div class="col-6 mt-3">
                                ...
                                <select name="input_resultado" id="input_resultado" class="form-control" required>
                                    ...
                                    <option value="pendente" <?= ($resultado_atual == 'pendente') ? 'selected' : '' ?>>
                                        Pendente</option>
                                    <option value="vendido" <?= ($resultado_atual == 'vendido') ? 'selected' : '' ?>>
                                        Vendido</option>
                            ...
                            <div class="col-12 mt-3">
                                ...
                                <textarea class="form-control" id="comentarios" name="comentarios"
                                    rows="4"><?= htmlspecialchars($comentarios_atual) ?></textarea>
                            </div>
