...
$sql_global_imoveis = "SELECT COUNT(ID_Imoveis) as Contagem_de_imoveis FROM imoveis WHERE Disponibilidade = 1  ;";
                      ...
                      <div class="property-item" style="cursor:pointer;"
                        ...
                        <a class="property-link">
                          <div class="property-image-wrapper">
                            <img src="../../administracao/img/principal/<?= $imagens ?>"
                          ...
                          <div class="property-agent-info d-flex align-items-center justify-content-between">
                            <a class="d-flex align-items-center ">
                              <div class="agent-avatar me-3">
                                <img
                                  src="../../administracao/img/agents/<?= $Imagem_agente; ?>"
