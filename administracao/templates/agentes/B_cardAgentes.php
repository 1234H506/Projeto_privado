        ...
        <div class='card shadow mb-4'>
            ...
            <div class='card-body'>
                ...
                <div class='d-flex flex-wrap justify-content-between mt-4'>
                    ...
                    <form action='../../form/agente/B_alterar_agente.php' method='post' class="mb-2" >
                            ...
                            <div class='modal-dialog modal-dialog-centered' role='document'>
                                <div class='modal-content'>
                                    ...
                                    <div class='modal-footer'>
                                        ...
                                        <form action='../../processo/agente/B_excluir_agente_consul.php' method='post'
                                            class='d-inline'>
                                            <input type='hidden' name='id' value='<?= $id; ?>'>
                            ...
                            <div class='modal-dialog modal-dialog-centered' role='document'>
                                <div class='modal-content'>
                                    ...
                                    <div class='modal-footer'>
                                        ...
                                        <form action='../../processo/agente/B_arquivar_agente_consul.php' method='post' class='d-inline'>
                                            <input type='hidden' name='id' value='<?= $id; ?>'>
