      ...
      <div class="properties-masonry view-masonry active" data-aos="fade-up" data-aos-delay="250">
        <div class="row g-4">
          ...
          ?>
              ...
              <div class="col-lg-4 col-md-6">
                <div class="property-item" style="cursor:pointer;" onclick="window.location.href='A_agente_property-details.php?id=<?= $id_imoveis; ?>'">
                  <a class="property-link">
                    <div class="property-image-wrapper">
                      <img src="/administracao1/startbootstrap-sb-admin-2-gh-pages/img/principal/<?= $imagens ?>" alt="Luxury Villa" class="img-fluid">
                      <div class="property-status">
                        <span class="status-badge sale">Para <?= $Servico; ?> </span>
                      </div>
                      <div class="property-actions">
                        <button class="action-btn favorite-btn" data-toggle="tooltip" title="Add to Favorites" onclick="event.stopPropagation(); return false;">
                          <i class="bi bi-heart"></i>
                        </button>
                        <button class="action-btn share-btn" data-toggle="tooltip" title="Share Property" onclick="event.stopPropagation(); return false;">
                    ...
                    <div class="property-agent-info d-flex align-items-center justify-content-between">
                      <a class="d-flex align-items-center">
                        <div class="agent-avatar me-3">
                          <img src="/administracao1/startbootstrap-sb-admin-2-gh-pages/img/agents/<?= $Imagem_agente; ?>" alt="Agent" class="rounded-circle" width="48" height="48">
                        </div>
